...
const MM_MAX_CLOSED = numEnv('MM_MAX_CLOSED_30D', 1500, 1);
...
function trustGrade(d30, d7, coin, addr) {
  ...
  // Market-maker guard. A wallet closing thousands of positions a month, or winning 95%+ of hundreds,
  // is quoting both sides of the book, not calling direction: its "win rate" counts spread captured,
  // and nobody can copy it. Measured on the live floor (Sep 22): one such wallet showed 5,864 wins
