...
function trustGrade(d30, d7, coin, addr, opts = {}) {
  ...
  const health = opts.health !== undefined ? opts.health : (addr ? healthLib.peek(addr) : null);
  const hl8 = opts.holdsLosers !== undefined ? opts.holdsLosers : tclass.holdsLosersOf(d30, health);
