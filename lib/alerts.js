...
export async function scan({ force = false } = {}) {
  ...
  try {
    ...
    for (const t of fresh) {
      ...
      // Nansen's feed lags, and alerts fire up to 45 minutes after the trade. A fast whale can be out
...
function readLines(a) {
  ...
  if (tells.length) {
    out.push('The dealer\u2019s tells \u2014 \u{1F7E3} points to FOLLOW, \u{1F7E0} points to FADE:');
