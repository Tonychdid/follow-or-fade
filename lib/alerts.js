...
function whoLine(a) {
  ...
  const early = a.early ? ` · EARLY FINDER (${e ? `in before ${e.goodFinds} of ${e.finds} big moves and held for them, keeping ${Math.round((e.capture || 0) * 100)}% of the move` : 'gets in before big moves and holds for them'})` : '';
