 ...
 * Without this, only the weekly roster ever recorded one, which left 89 of 140 pool whales carrying
...
export async function classify(addr) {
  ...
  const earlyFew = !early && findFresh && good.length >= FEW_MIN_FINDS() && convert >= FEW_MIN_CONVERT() && pnl > 0;
